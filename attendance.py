...
titl = tk.Label(window, bg="#538cf8", relief=RIDGE, bd=10, font=("arial", 35))
titl.pack(fill=X)
l1 = tk.Label(window, image=logo1, bg="#72f8b7",)
l1.place(x=470, y=10)

titl = tk.Label(
    window, text="Saraswati College of Engineering", bg="#72f8b7", fg="#fd2020", font=("algerian", 27),
)
